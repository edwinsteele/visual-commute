...
class Line(models.Model):
    ...
    def index_on_line(self, station_name):
        idx = StationLineOrder.objects.filter(
...
class Trip(models.Model, vcapp.trip_helpers.AbstractTrip):
    ...
    timetable_type = models.CharField(max_length=2,
...
class Segment(models.Model):
    ...
    departure_tripstop = models.ForeignKey('TripStop',
                                           related_name='departure_point')
    arrival_tripstop = models.ForeignKey('TripStop',
    ...
    def segment_length(self):
        return self.departure_tripstop.station.\
            distance_from(self.arrival_tripstop.station)
